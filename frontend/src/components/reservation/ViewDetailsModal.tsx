...
const ViewDetailsModal = ({ isOpen, onClose, booking }: ModalProps) => {
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full max-h-[85vh] p-5 relative flex flex-col">
        ...
        <div className="flex-grow overflow-y-auto space-y-3 text-sm text-gray-700">
          ...
          <p>
            ...
            {booking?.card?.cardHolderName || "Walk-in"}
          </p>

          <p>
            <strong>Card Type:</strong> {booking?.card?.cardType || "Walk-in"}
          </p>

          <p>
            <strong>Expiration:</strong>{" "}
            {booking?.card?.expiration || "Walk-in"}
          </p>

          <p>
            <strong>Last 4 Digits:</strong>{" "}
            {booking?.card?.last4Digits || "Walk-in"}
          </p>
          ...
          <p>
            ...
            {durationDays && durationDays > 1 ? "s" : ""}
          </p>

          <p>
            <strong>Country:</strong> {booking?.country || "Walk-in"}
          </p>
