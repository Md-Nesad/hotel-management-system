...
const AddPromoCode: React.FC = () => {
  ...
  const handleSubmit = async (values: PromotionFormValues) => {
    ...
    try {
      ...
      const res = await fetch("https://backend.bahamaslrb.com/promotion/add", {
        method: "POST",
        headers: {
      ...
      console.error(error);
      alert("Error saving promotion> Please login again or try later.");
    } finally {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <Field
                      ...
                      type="text"
                      className="block w-full p-2 bg-gray-100 border border-gray-200 rounded-md text-gray-400 cursor-not-allowed"
                      disabled
                    />
                    <ErrorMessage
                      name="promoCode"
