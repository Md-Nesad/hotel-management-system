...
const RoomImageCarousel = lazy(() => import('../RoomImageCarousel'))
        ...
        <div className='py-12 sm:py-16 bg-gradient-to-b from-black to-gray-900'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-12'>
            <div className='text-center mb-8 sm:mb-10 fade-in'>
              <h2 className='text-2xl sm:text-3xl font-nunito font-extrabold text-white tracking-wide'>
                {pageData?.roomTitle || 'Stay With Us by Booking Today'}
              </h2>
              <p className='mt-2 text-[#FFFFFF] font-inter text-sm sm:text-base'>
                {pageData?.roomSubTitle ||
            ...
            <div className='text-center mt-6 sm:mt-10'>
              <Link to='/book-now'>
                <button className='bg-black hover:bg-[#F9862D] border-[0.5px] border-white text-[#FFFFFF] hover:border-[#F9862D] text-xs sm:text-sm font-inter font-medium py-2 sm:py-3 px-6 sm:px-8 rounded-md transition duration-200 shadow-md hover:shadow-lg transform hover:scale-105 cursor-pointer'>
                  {pageData?.roomButton || 'Book Now'}
                </button>
              </Link>
            </div>
          </div>
