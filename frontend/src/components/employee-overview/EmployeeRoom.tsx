            ...
            {filteredRooms.length > 0 ? (
              filteredRooms.map((room) => (
                ...
                >
                  ...
                  <td className="border border-gray-200 px-3 py-6 flex space-x-2 ">
                    <Link
                      to={`/dashboard/update-room/${room.id}`}
                      className="text-black bg-gray-300 p-1"
                    >
                      <Pencil size={16} />
                    </Link>
                    <Link
